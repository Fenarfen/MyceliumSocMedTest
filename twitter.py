...
# haven't done that ^^ i just added my keys as a variable below

# consumer_key = os.environ.get("CONSUMER_KEY")
# consumer_secret = os.environ.get("CONSUMER_SECRET")

consumer_key = "baU171tGmMO7K365mRJ6nLJ7U"
consumer_secret = "xIVlqulwqnOIfFjOtvQh9d4Ul4ExYgjiXRin1GQWQZZYQqsuVA"
